---
description: Get help with lumioguard CC.
---
...
-   [:lucide-life-buoy:{ .lg-icon } **Troubleshooting**](troubleshooting.md)

    Incomplete results, parse failures, Git errors, and checks that never fail.

-   [:lucide-circle-help:{ .lg-icon } **FAQ**](faq.md)
